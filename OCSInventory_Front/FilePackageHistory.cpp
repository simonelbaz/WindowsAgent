...
BOOL CFilePackageHistory::Open(LPUTSTR lpstrFile, BOOL bForWriting, BOOL bExclusive)
{
	BOOL bReturn = FALSE;
...
BOOL CFilePackageHistory::AddPackage(LPUTSTR lpstrPackageID)
{
	try
	{
		CString csBuffer;
...
int CFilePackageHistory::CleanDuplicates(LPUTSTR lpstrFile, BOOL bForce)
{
...
BOOL CFilePackageHistory::AddPackage(LPUTSTR lpstrFile, LPUTSTR lpstrPackageID)
{
