...
BOOL CNotifyUser::getActiveConsoleSessionID()
{
	...
	for (DWORD64 dwIndex=0; (dwIndex<dwCount) && (dwSessionID == OCS_NO_WTS_SESSION_ID); dwIndex++)
	{
...
UINT CNotifyUser::AskQuestion( LPUTSTR lpstrText)
{
	CString csCommand;
...
UINT CNotifyUser::ShowInformation( LPUTSTR lpstrText)
{
	CString csCommand;
...
UINT CNotifyUser::ShowPreInstall( LPUTSTR lpstrText, BOOL bCancelAllowed, BOOL bDelayAllowed, UINT uTimeOut)
{
	CString csCommand;
...
UINT CNotifyUser::ShowPostInstall( LPUTSTR lpstrText, BOOL bRebootRequired, BOOL bDelayAllowed, UINT uTimeOut)
{
	CString csCommand;
...
UINT CNotifyUser::AskTag( LPUTSTR lpstrText, CString &csTag)
{
