...
public: // Methods
	...
	virtual BOOL getLabel( LPUTSTR lpstrFilename) = NULL;
	// A simple get that get a binary content into a file
	virtual BOOL getFile( LPUTSTR lpstrURL, LPUTSTR lpstrFilename) = NULL;

	// Get Status Code or Error Code
	virtual DWORD64 getErrorStatus() = OCS_RESPONSE_ERROR_SUCCESS;
	virtual LPUTSTR getErrorString() = NULL;
