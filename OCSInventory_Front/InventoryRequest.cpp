...
LONG CInventoryRequest::SearchFilesInDirectory(LPUTSTR lpstrDir, LPUTSTR lpstrExtensionToSearch, LPUTSTR lpstrFoldersToExclude)
{
...
BOOL CInventoryRequest::IsExtensionToSearch( LPUTSTR lpstrFilename, LPUTSTR lpstrExtension)
{
...
BOOL CInventoryRequest::IsExcludeFolder( LPUTSTR lpstrFolder, LPUTSTR lpstrFolderToSkip)
{
