...
__int64 OCSINVENTORYFRONT_API GetDiskFree( LPUTSTR lpstrDrive)
{
	...
	typedef BOOL (WINAPI *P_GDFSE)(LPUTSTR, PULARGE_INTEGER,
...
BOOL OCSINVENTORYFRONT_API fileDigest( LPUTSTR lpstrFile, CString &csDigest, LPUTSTR lpstrAlgo, BOOL bBase64)
{
	CFile	fRead;
	BYTE	pBuffer[1024],
