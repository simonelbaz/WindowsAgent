...
void CLog::setApplication( LPUTSTR lpstrApp)
{
	if (m_bLogOpened)
	{
		// Already opened
...
void CLog::log(int iPriority, LPUTSTR lpstrLog, ...)
{
	va_list args;
...
void CLog::log_error( LPUTSTR lpstrFormat, va_list args)
{
	try
	{
...
void CLog::log_notice( LPUTSTR lpstrFormat, va_list args)
{
	try
	{
		CString csLog, csMessage;
...
void CLog::log_debug( LPUTSTR lpstrFormat, va_list args)
{
	try
	{
		CString csLog, csMessage;
...
void CLog::log_warning( LPUTSTR lpstrFormat, va_list args)
{
	try
	{
		CString csLog, csMessage;
...
void CLog::log_trace( LPUTSTR lpstrFormat, va_list args)
{
	try
	{
		CString csLog, csMessage;
...
void CLog::setLogLevel(DWORD64 dwLogLevel)
{
