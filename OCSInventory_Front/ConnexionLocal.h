...
public://Methods
	CConnexionLocal( LPUTSTR lpstrFilename);
	...
	BOOL getFile( LPUTSTR lpstrURL, LPUTSTR lpstrFilename);
	BOOL getLabel( LPUTSTR lpstrFilename);

	// Get Status Code or Error Code
	DWORD64 getErrorStatus();
	LPUTSTR getErrorString();
