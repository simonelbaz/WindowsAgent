...
CConnexionLocal::CConnexionLocal(LPUTSTR lpstrFilename)
{
...
BOOL CConnexionLocal::getFile( LPUTSTR lpstrURL, LPUTSTR lpstrFilename)
{
	ASSERT( lpstrURL);
	ASSERT( lpstrFilename);
...
DWORD64 CConnexionLocal::getErrorStatus()
{
	return m_dwErrorCode;
}

LPUTSTR CConnexionLocal::getErrorString()
{
	return m_csErrorString;
}


BOOL CConnexionLocal::getLabel( LPUTSTR lpstrFilename)
{
	ASSERT( lpstrFilename);
